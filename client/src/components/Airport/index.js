      ...
      <div>
        ...
        <div className="flex -mx-2">
          <section id="middle-region" className="flex-1 w-1/4 px-2">
            <div>
              <strong className="text-5xl">ARE YOU CARRYING ANY GUNS?</strong>
            </div>
            <div>
              <img src="/gun_icon.png" id="gun" className={gun} />
            </div>
            <ul>
              <li className="list-reset">
                <button className="bg-red hover:bg-red-dark text-white font-bold py-2 px-4 rounded min-w-full mb-1 h-32"
                        value="YES">YES
                </button>
                <button id="no"
